...
new='''    if (diag4m_out4(text)) {\n      gpio_command_recognized = true;\n    }\n'''
if old not in s: raise SystemExit('OUT4 block missing')
s=s.replace(old,new,1)
p.write_text(s)
print('DIAG4M: third OUT4 command only, no futureMillis and no loop timer code')
