...
# Add OUT5..OUT7 timer globals after OUT4 globals from the V4/V5 base.
...
new_status = '''    const char* out1 = "NA"; const char* out2 = "NA"; const char* out3 = "NA"; const char* out4 = "NA";
    const char* out5 = "NA"; const char* out6 = "NA"; const char* out7 = "NA";
    const char* in1 = "NA"; const char* in2 = "NA"; const char* in3 = "NA"; const char* in4 = "NA";
'''
...
new_fmt = '    snprintf(gpio_reply_buf, sizeof(gpio_reply_buf), "O1=%s O2=%s O3=%s O4=%s O5=%s O6=%s O7=%s | I1=%s I2=%s I3=%s I4=%s", out1,out2,out3,out4,out5,out6,out7,in1,in2,in3,in4);'
if old_fmt not in s:
    raise SystemExit("STATUS format anchor not found")
s = s.replace(old_fmt, new_fmt, 1)
s = s.replace('  char gpio_reply_buf[192];', '  char gpio_reply_buf[224];', 1)

# Initialize OUT5..OUT7 LOW at boot.
...
# Timer expiry handling for OUT5..OUT7.
...
# Removed from the earlier V6 draft: GPIO1, GPIO39 and GPIO41.
p = Path("variants/heltec_v3/platformio.ini")
s = p.read_text()
needle = '  -D REMOTE_GPIO_IN4=34\n'
flags = (
    '  -D REMOTE_GPIO_OUT5=2\n'
    '  -D REMOTE_GPIO_OUT6=40\n'
    '  -D REMOTE_GPIO_OUT7=42\n'
)
...
print("Heltec V3 GPIO V6: V5 Link Persistent + OUT5=2 OUT6=40 OUT7=42")
